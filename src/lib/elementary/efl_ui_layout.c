...
_efl_ui_layout_efl_ui_view_model_set(Eo *obj, Efl_Ui_Layout_Data *pd, Efl_Model *model)
{
   ...
   efl_ui_view_model_set(efl_super(obj, EFL_UI_LAYOUT_CLASS), model);
...
EOLIAN static Eina_Bool
_efl_ui_layout_efl_ui_property_bind_property_bind(Eo *obj, Efl_Ui_Layout_Data *pd, const char *key, const char *property)
{
   ...
   r = efl_ui_property_bind(efl_super(obj, EFL_UI_LAYOUT_CLASS), key, property);
   if (r) return r;
